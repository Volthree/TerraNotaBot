...
@Component
public class HillComponent implements ReplyMarcupInt {
    ...
    public HillComponent(ReplyMarkupService replyMarkupService,
    ...
    public void setReplyMarcup() {
        ...
        userParametersService.mapHeightParameter(userParameters, 4, replyMarkupService);
    }
